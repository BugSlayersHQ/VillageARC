      ...
      <section id="hero" className="hero-section">
        <div className="container hero-content">
          ...
          <p className="body-lg hero-desc">
            A proposed AI-powered platform utilizing advanced OCR, Computer Vision, and Natural
            Language Processing to recognize printed and handwritten text in multiple Indian
            languages, automatically extract structured attributes from legacy registers, maps, and
            scanned PDFs, and validate records for modern land-management systems.
          </p>
            ...
            <div className="window-body">
              ...
              <main className="editor-canvas">
                <div className="doc-breadcrumbs">
                  <span style={{ color: 'var(--color-tertiary)', fontWeight: '700' }}>
                    [Illustrative Demonstration Sample]
                  </span>{' '}
                  / <span>District: Sample District</span> / <span>Tehsil: Sample Tehsil</span> /{' '}
                  <span>Village: Sample Village</span>
                </div>

                <div className="doc-header-row">
                  <h2 className="doc-title">
                    Intelligent Land Record Classification &amp; Extraction (Illustrative Mockup)
                  </h2>
                  <div className="doc-authors">
                    <div title="Revenue Inspector (Role)" className="author-avatar a1">
                      RI
                    </div>
                    <div title="Reviewing Officer (Role)" className="author-avatar a2">
                      RO
                    </div>
                    <div title="AI Extraction Pipeline" className="author-avatar a3">
                      AI
                    </div>
                  </div>
                </div>
                ...
                <div className="doc-meta-tags">
                  <span className="doc-meta-pill">
                    Document: Sample Scanned Historical Register
                  </span>
                  <span className="doc-meta-pill">Script: Multilingual Recognition</span>
                  <span
                    style={{ color: '#047857', background: '#ECFDF5' }}
                    className="doc-meta-pill"
                  >
                    ● Automated Rules Checked
                  </span>
                  <span
                    style={{ color: '#B45309', background: '#FFFBEB' }}
                    className="doc-meta-pill"
                  >
                    ● Uncertain Field Identified
                  </span>
                </div>

                <p className="doc-body-text">
                  Demonstration of how the proposed system analyzes a sample historical record,
                  automatically maps attributes to predefined fields, applies confidence scoring,
                  and flags uncertain values for human verification.{' '}
                  <em>
                    (Note: All names, numbers, and locations below are illustrative fictional
                    demonstration data).
                  </em>
                </p>
                  ...
                  <table className="record-fields-table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <strong>Sample Landowner Name (Illustrative Record)</strong>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <code>Sample Survey No. 101</code>
                        </td>
                        <td>
                          <span className="badge-status confidence-high">● High Confidence</span>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <code>Sample Khasra No. 101/1</code>
                        </td>
                        <td>
                          <span className="badge-status confidence-high">● High Confidence</span>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <strong>1.25 Hectares</strong> (3.08 Acres) [Sample]
                        </td>
                        <td>
                          <span className="badge-status needs-review">⚠ Needs Review</span>
                        </td>
                      </tr>
                      <tr>
                        <td>
              ...
              <aside className="workspace-inspector">
                <div className="inspector-card">
                  ...
                  <div className="inspector-text">
                    Demonstration of confidence assessment and automatic identification of uncertain
                    fields:
                  </div>
                  <div
                    style={{
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        style={{ fontSize: '10px', padding: '1px 6px' }}
                        className="badge-status confidence-high"
                      >
                        High Confidence
                      </span>
                    </div>
                    ...
                    >
                      ...
                      <span
                        style={{ fontSize: '10px', padding: '1px 6px' }}
                        className="badge-status needs-review"
                      >
                        Needs Review
                      </span>
                    </div>
                  ...
                  <div className="ai-pill-summary">
                    <strong>Illustrative Uncertainty Detection:</strong>
                    <br />
                    Plot area ink identified as faded. Automatically routed to human-assisted
