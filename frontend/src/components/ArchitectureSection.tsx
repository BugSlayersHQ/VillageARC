      ...
      <section id="architecture" className="section">
        <div className="container">
          <div className="section-header">
            ...
            <p className="body-md">
              A proposed multi-tier deployment framework designed to integrate with state land
              administration infrastructure and national digital governance platforms.
            </p>
          </div>

          <div className="pricing-grid">
            <div className="card pricing-card">
              <div style={{ fontSize: '10px', marginBottom: '12px' }} className="chip">
                TIER 1
              </div>
              <h3 className="pricing-plan-title">Ingestion &amp; Preprocessing</h3>
              <p className="pricing-plan-desc">
                Intake layer for physical and scanned document archives.
              </p>
            ...
            <div className="card pricing-card featured">
              ...
              <div style={{ fontSize: '10px', marginBottom: '12px' }} className="chip chip-accent">
                TIER 2
              </div>
              <h3 className="pricing-plan-title">AI Processing &amp; Validation</h3>
              <p className="pricing-plan-desc">
                Intelligent recognition, extraction, and validation pipeline.
              </p>
              <ul className="pricing-features-list">
                <li className="pricing-feature-item">
                  <span className="check-icon">✓</span>
            ...
            <div className="card pricing-card">
              ...
              <p className="pricing-plan-desc">
                Integration with governance platforms and GIS systems.
              </p>
              <ul className="pricing-features-list">
                <li className="pricing-feature-item">
                  <span className="check-icon">✓</span>
