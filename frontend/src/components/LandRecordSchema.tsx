      ...
      <section id="land-data" className="section">
        <div className="container">
          <div className="section-header">
            ...
            <p className="body-md">
              The proposed system automatically extracts and classifies information into the twelve
              predefined fields explicitly specified in the project study document.
            </p>
          </div>
          ...
          <div style={{ gridTemplateColumns: 'repeat(4, 1fr)' }} className="bento-grid">
            <div className="card bento-card">
              <div className="card-inner">
                ...
                <p style={{ fontSize: '12px', color: 'var(--color-secondary)' }}>
                  Name and details of title holders, co-sharers, parentage, and legal identification
                  references.
                </p>
              </div>
            </div>
            ...
            <div className="card bento-card">
              <div className="card-inner">
                ...
                <p style={{ fontSize: '12px', color: 'var(--color-secondary)' }}>
                  Official revenue survey identification assigned during administrative land
                  surveys.
                </p>
              </div>
            </div>
            ...
            <div className="card bento-card">
              <div className="card-inner">
                ...
                <p style={{ fontSize: '12px', color: 'var(--color-secondary)' }}>
                  Specific plot or parcel identifier representing land subdivisions within the
                  revenue boundary.
                </p>
              </div>
            </div>
            ...
            <div className="card bento-card">
              <div className="card-inner">
                ...
                <p style={{ fontSize: '12px', color: 'var(--color-secondary)' }}>
                  Account ledger identifier grouping landholdings belonging to a single title holder
                  or family unit.
                </p>
              </div>
            </div>
            ...
            <div className="card bento-card">
              <div className="card-inner">
                ...
                <p style={{ fontSize: '12px', color: 'var(--color-secondary)' }}>
                  Land measurement recorded in standardized metric units and legacy regional
                  measurement units.
                </p>
              </div>
            </div>
            ...
            <div className="card bento-card">
              <div className="card-inner">
                ...
                <p style={{ fontSize: '12px', color: 'var(--color-secondary)' }}>
                  Revenue village (Mauza) jurisdiction indicating the local administrative origin of
                  the parcel.
                </p>
              </div>
            </div>
            ...
            <div className="card bento-card">
              <div className="card-inner">
                ...
                <p style={{ fontSize: '12px', color: 'var(--color-secondary)' }}>
                  Sub-district administrative revenue division (Taluka/Tehsil) overseeing the
                  village records.
                </p>
              </div>
            </div>
            ...
            <div className="card bento-card">
              <div className="card-inner">
                ...
                <p style={{ fontSize: '12px', color: 'var(--color-secondary)' }}>
                  Primary district revenue jurisdiction encompassing the sub-district administrative
                  boundaries.
                </p>
              </div>
            </div>
            ...
            <div className="card bento-card">
              <div className="card-inner">
                ...
                <p style={{ fontSize: '12px', color: 'var(--color-secondary)' }}>
                  Official categorization of the parcel (e.g. agricultural, irrigated, residential,
                  or commercial).
                </p>
              </div>
            </div>
            ...
            <div className="card bento-card">
              <div className="card-inner">
                ...
                <p style={{ fontSize: '12px', color: 'var(--color-secondary)' }}>
                  Tenure status, occupant classification, shareholding proportions, and registered
                  rights.
                </p>
              </div>
            </div>
            ...
            <div className="card bento-card">
              <div className="card-inner">
                ...
                <p style={{ fontSize: '12px', color: 'var(--color-secondary)' }}>
                  Historical record of title transfers, inheritance, succession entries, partitions,
                  and amendments.
                </p>
              </div>
            </div>
            ...
            <div className="card bento-card">
              <div className="card-inner">
                ...
                <p style={{ fontSize: '12px', color: 'var(--color-secondary)' }}>
                  Deed registration references, document numbers, dates, and sub-registrar office
                  details.
                </p>
              </div>
            </div>
