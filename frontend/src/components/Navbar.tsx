      ...
      <header id="mainHeader" className="site-header">
        <div className="container nav-container">
          ...
          <nav aria-label="Main Navigation" className="nav-menu">
            ...
            <a href="#ai-approach" className="nav-link">
              AI Intelligence
            </a>
            <a href="#land-data" className="nav-link">
              Predefined Fields
            </a>
          ...
          <div className="nav-actions">
            <button
              type="button"
              id="cmdSearchTrigger"
              aria-label="Search sample land records and schema"
        ...
        <div id="mobileNavDrawer" className="mobile-nav-drawer">
          ...
          <a href="#stakeholders" className="nav-link">
            Stakeholders
          </a>
          <div style={{ display: 'flex', gap: '12px', marginTop: '8px' }}>
            <a href="#workflow" style={{ flex: '1' }} className="btn btn-secondary">
              View Workflow
            </a>
            <a href="#features" style={{ flex: '1' }} className="btn btn-primary">
              Explore Solution
            </a>
          </div>
        </div>
