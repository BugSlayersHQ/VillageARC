...
let SignUpComponent: React.ComponentType<{ appearance?: Record<string, unknown> }> | null = null;
try {
  // eslint-disable-next-line @typescript-eslint/no-require-imports
  const clerk = require('@clerk/nextjs');
  SignUpComponent = clerk.SignUp;
} catch {
      ...
      {SignUpComponent ? (
        ...
        >
          ...
          <p style={{ fontSize: '13px', color: '#57534d', lineHeight: 1.5, marginBottom: '16px' }}>
            ...
            keys in <code>.env.local</code> to activate the live registration form.
          </p>
